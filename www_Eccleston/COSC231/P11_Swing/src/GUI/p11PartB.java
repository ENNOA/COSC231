...
public class p11PartB {
	public static void main(String[] args) {
		...
		Border style = BorderFactory.createDashedBorder(new Color(255,0,255));
		
		// set the frame size and background color
		frame.setSize(500,500);   
		frame.getContentPane().setBackground(new Color(185,197,211)); // several default        
		...
		label.setFont(new Font(Font.SERIF, Font.BOLD, 24)); // BlueJ does not do this
		label.setForeground(new Color(0,0,0));  // Change color of text, font,
		...
		label.setVerticalAlignment(JLabel.TOP);  // TOP, CENTER, or BOTTOM
		label.setHorizontalAlignment(JLabel.RIGHT); // LEFT, CENTER, or RIGHT
